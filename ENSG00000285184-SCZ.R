...
##perl  /storage/yangjianLab/chenli/seq/PsychENCODE/metaeQTL/SMR/locos_plot/get_input_for_locusplot.pl  /storage/yangjianLab/sharedata/GWAS_summary/01_Public/01_cojo/PGC3_SCZ_wave3_public_INFO80.txt  /storage/yangjianLab/guoyazhou/data/SNPs_database/dbSNP/dbSNP_b151/split_into_chrAuto/  /storage/yangjianLab/chenli/seq/PsychENCODE/CMC/merge/eQTL1/newlncRNA_exp.GeneLncRNA.hg19.bed  /storage/yangjianLab/guoyazhou/data/genecode_data/genecode_v43/v43lift37/gencode.v43lift37.annotation.gene.bed  ENSG00000285184  500000  /storage/yangjianLab/chenli/seq/PsychENCODE/metaeQTL/BrainMeta.lncRNAeQTL.chr  > locus_input_data.txt  
...
##perl  /storage/yangjianLab/chenli/seq/PsychENCODE/metaeQTL/SMR/locos_plot/get_input_for_locusplot.pl  /storage/yangjianLab/sharedata/GWAS_summary/01_Public/01_cojo/EA_NG_2018_excluding_23andMe.txt  /storage/yangjianLab/guoyazhou/data/SNPs_database/dbSNP/dbSNP_b151/split_into_chrAuto/  /storage/yangjianLab/chenli/seq/PsychENCODE/CMC/merge/eQTL1/newlncRNA_exp.GeneLncRNA.hg19.bed  /storage/yangjianLab/guoyazhou/data/genecode_data/genecode_v43/v43lift37/gencode.v43lift37.annotation.gene.bed  BrainMetalnc.13526  500000  /storage/yangjianLab/chenli/seq/PsychENCODE/metaeQTL/BrainMeta.lncRNAeQTL.chr  > locus_input_data.BrainMetalnc.13526.txt 
...
##rs2027349  322  chr1 150039678 2.508e-07 rs2027349 #2b5799
##lead snp 630  chr1 150115398 7.214e-09 rs12138231 #2b5799
GWAS_trait_name="SCZ"
GWAS_file="/storage/yangjianLab/sharedata/GWAS_summary/01_Public/01_cojo/PGC3_SCZ_wave3_public_INFO80.txt"
probe=c("ENSG00000285184")
probe_gene=c("ENSG00000136631")
highlight_probe=c("ENSG00000285184")
window_size=500000
probe_list=probe
probe_gene_list=probe_gene
filename<-"/storage/yangjianLab/chenli/seq/PsychENCODE/metaeQTL/SMR/locos_plot/locus_input_data.txt"
finemap_file<-"/storage/yangjianLab/chenli/seq/PsychENCODE/lncRNA_eQTL/enrichment/finemap/sczfinemap/scz.rs12138231.locus.CARMA.txt"
finemap_file<-"/storage/yangjianLab/chenli/seq/PsychENCODE/lncRNA_eQTL/enrichment/finemap/sczfinemap_ANN/scz.rs12138231.locus.CARMA.ANN.txt"
...
plink   --bfile /storage/yangjianLab/sharedata/LD_reference/UKB/genotype_10K/BED_ukbEUR_imp_v3_INFO0.8_maf0.01_mind0.05_geno0.05_hwe1e6_10K_chr11  \
    --chr 11 \
    --from-bp 78617402  \
    --to-bp 79652990 \
    --r2 \
...
plink   --bfile /storage/yangjianLab/sharedata/LD_reference/UKB/genotype_10K/BED_ukbEUR_imp_v3_INFO0.8_maf0.01_mind0.05_geno0.05_hwe1e6_10K_chr14  \
    --chr 14 \
    --from-bp 71937533  \
    --to-bp 73160186 \
    --r2 \
...
plotLegend(
  ...
  annoHighlight(
    ...
    y =  y0 , height = 23.5, just = c("left", "top"),
...
##      )
			    ...
			    plotGenomeLabel(
			      chrom = chr, chromstart = start, chromend = end,
			      assembly = "hg19",
			      x = x0, y = 25.0, length = width0, scale = "Mb",
			      just = c("left", "top"), default.units = "cm",
			      fontsize = 8
			    )
...
pdf("lnc-ENSG00000285184.pdf",  width=10,height=13)  
gwasLocusPlot()
dev.off()
