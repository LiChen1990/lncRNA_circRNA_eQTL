...
##perl  /storage/yangjianLab/chenli/seq/PsychENCODE/metaeQTL/SMR/locos_plot/get_input_for_locusplot.pl  /storage/yangjianLab/sharedata/GWAS_summary/01_Public/01_cojo/PGC3_SCZ_wave3_public_INFO80.txt  /storage/yangjianLab/guoyazhou/data/SNPs_database/dbSNP/dbSNP_b151/split_into_chrAuto/  /storage/yangjianLab/chenli/seq/PsychENCODE/CMC/merge/eQTL1/newlncRNA_exp.GeneLncRNA.hg19.bed  /storage/yangjianLab/guoyazhou/data/genecode_data/genecode_v43/v43lift37/gencode.v43lift37.annotation.gene.bed  BrainMetalnc.44390  500000  /storage/yangjianLab/chenli/seq/PsychENCODE/metaeQTL/BrainMeta.lncRNAeQTL.chr  > locus_input_data.BrainMetalnc.44390.txt  

##perl  /storage/yangjianLab/chenli/seq/PsychENCODE/metaeQTL/SMR/locos_plot/get_input_for_locusplot.pl  /storage/yangjianLab/sharedata/GWAS_summary/01_Public/01_cojo/PGC3_SCZ_wave3_public_INFO80.txt  /storage/yangjianLab/guoyazhou/data/SNPs_database/dbSNP/dbSNP_b151/split_into_chrAuto/  /storage/yangjianLab/chenli/seq/PsychENCODE/CMC/merge/eQTL1/newlncRNA_exp.GeneLncRNA.hg19.bed  /storage/yangjianLab/guoyazhou/data/genecode_data/genecode_v43/v43lift37/gencode.v43lift37.annotation.gene.bed  BrainMetalnc.22630  500000  /storage/yangjianLab/chenli/seq/PsychENCODE/metaeQTL/BrainMeta.lncRNAeQTL.chr  > locus_input_data.BrainMetalnc.22630.txt  

##perl  /storage/yangjianLab/chenli/seq/PsychENCODE/metaeQTL/SMR/locos_plot/get_input_for_locusplot.pl  /storage/yangjianLab/sharedata/GWAS_summary/01_Public/01_cojo/PGC3_SCZ_wave3_public_INFO80.txt /storage/yangjianLab/guoyazhou/data/SNPs_database/dbSNP/dbSNP_b151/split_into_chrAuto/  /storage/yangjianLab/chenli/seq/PsychENCODE/CMC/merge/eQTL1/newlncRNA_exp.GeneLncRNA.hg19.bed  /storage/yangjianLab/guoyazhou/data/genecode_data/genecode_v43/v43lift37/gencode.v43lift37.annotation.gene.bed  BrainMetalnc.75172  500000  /storage/yangjianLab/chenli/seq/PsychENCODE/metaeQTL/BrainMeta.lncRNAeQTL.chr  > locus_input_data.BrainMetalnc.75172.txt 
...
probe=c("BrainMetalnc.43391")
highlight_probe=c("BrainMetalnc.43391")
window_size=500000
probe_list=probe
probe_gene_list=probe
filename<-"/storage/yangjianLab/chenli/seq/PsychENCODE/metaeQTL/SMR/locos_plot/locus_input_data.BrainMetalnc.43391.txt"
#finemap_file<-"/storage/yangjianLab/chenli/seq/PsychENCODE/lncRNA_eQTL/enrichment/finemap/EAfinemap_ANN/EA.rs73496688.locus.CARMA.txt"
#finemap_file<-"/storage/yangjianLab/chenli/seq/PsychENCODE/lncRNA_eQTL/enrichment/finemap/EAfinemap/EA.rs73496688.locus.CARMA.txt"
...
plink   --bfile /storage/yangjianLab/sharedata/LD_reference/UKB/genotype_10K/BED_ukbEUR_imp_v3_INFO0.8_maf0.01_mind0.05_geno0.05_hwe1e6_10K_chr8 --chr  8 --from-bp 142869593 --to-bp 143866614 --r2 --ld-window 10000000  --ld-window-kb 1000  --ld-window-r2 0 --ld-snp  rs13262595 --out rs13262595


plink   --bfile /storage/yangjianLab/sharedata/LD_reference/HRS/hrs_1kg_hwe1e-6_chr1  \
    --chr 1 \
    --from-bp 148578355  \
    --to-bp 151535142 \
    --r2 \
    ...
    --ld-window-r2 0 \
    --ld-snp rs12138231 \
    --out rs12138231.hrs --make-founders  
    

plink   --bfile /storage/yangjianLab/sharedata/LD_reference/UKB/genotype_10K/BED_ukbEUR_imp_v3_INFO0.8_maf0.01_mind0.05_geno0.05_hwe1e6_10K_chr1  \
    --chr 1 \
    --from-bp 148578355  \
    --to-bp 151535142 \
    --r2 \
...
#ld<-read.table(file="rs778371.ld",header=T);  
...
plotLegend(
    ...
    pch = c(19, 19,19,19,19,19), border = FALSE, x = x0+width0-3, y = y0,
...
#    y =  y0 , height = 18, just = c("left", "top"),
...
########################## plot the gene labels #######################
  ...
  generow
  dist = 1
  yMax=y0 + (height0 + gap0)*probe_index + (height0 + gap0)*probe_gene_index + height0 + 1 + 0.8*num_row - 3 
  yMax
...
##		    x = x0, y = 16  , width =width0, height = height0-1,
...
##      )
			    ...
			    plotGenomeLabel(
			      chrom = chr, chromstart = start, chromend = end,
			      assembly = "hg19",
			      x = x0, y = 19.5, length = width0, scale = "Mb",
			      just = c("left", "top"), default.units = "cm",
			      fontsize = 8
			    )
...
pdf("lnc-BrainMetalnc.13526.pdf",  width=10,height=13)  
gwasLocusPlot()
dev.off()			 