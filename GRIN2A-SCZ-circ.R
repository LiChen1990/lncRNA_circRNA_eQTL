...
perl  /storage/yangjianLab/chenli/seq/PsychENCODE/metaeQTL/SMR/locos_plot/get_input_for_locusplot_circ.pl  /storage/yangjianLab/sharedata/GWAS_summary/01_Public/01_cojo/PGC3_SCZ_wave3_public_INFO80.txt  /storage/yangjianLab/guoyazhou/data/SNPs_database/dbSNP/dbSNP_b151/split_into_chrAuto/  /storage/yangjianLab/chenli/softwares/circRNA/Test_CMC/test_pipeline/merge_all/Brain.circ.all.nochr.bed    /storage/yangjianLab/guoyazhou/data/genecode_data/genecode_v43/v43lift37/gencode.v43lift37.annotation.gene.bed  "chr16:9892134|9934961"  500000  /storage/yangjianLab/chenli/seq/PsychENCODE/metaeQTL/circRNA_meta_eQTL/BrainMeta.circRNA.chr    > circ_locus_input_data.txt  

perl  /storage/yangjianLab/chenli/seq/PsychENCODE/metaeQTL/SMR/locos_plot/get_input_for_locusplot_circ.pl  /storage/yangjianLab/sharedata/GWAS_summary/01_Public/01_cojo/PGC3_SCZ_wave3_public_INFO80.txt  /storage/yangjianLab/guoyazhou/data/SNPs_database/dbSNP/dbSNP_b151/split_into_chrAuto/  /storage/yangjianLab/chenli/softwares/circRNA/Test_CMC/test_pipeline/merge_all/Brain.circ.all.nochr.bed    /storage/yangjianLab/guoyazhou/data/genecode_data/genecode_v43/v43lift37/gencode.v43lift37.annotation.gene.bed  "chr16:9892134|9934961"  1000000  /storage/yangjianLab/chenli/seq/PsychENCODE/metaeQTL/circRNA_meta_eQTL/BrainMeta.circRNA.chr    > circ_locus_input_data1.txt


perl  /storage/yangjianLab/chenli/seq/PsychENCODE/metaeQTL/SMR/locos_plot/get_input_for_locusplot_circ_sQTL.pl  /storage/yangjianLab/sharedata/GWAS_summary/01_Public/01_cojo/PGC3_SCZ_wave3_public_INFO80.txt  /storage/yangjianLab/guoyazhou/data/SNPs_database/dbSNP/dbSNP_b151/split_into_chrAuto/  /storage/yangjianLab/chenli/softwares/circRNA/Test_CMC/test_pipeline/merge_all/Brain.circ.all.nochr.bed    /storage/yangjianLab/guoyazhou/data/genecode_data/genecode_v43/v43lift37/gencode.v43lift37.annotation.gene.bed  "chr16:9892134|9934961"  1000000  /storage/yangjianLab/chenli/seq/PsychENCODE/metaeQTL/circRNA_meta_eQTL/BrainMeta.circRNA.chr  /storage/yangjianLab/chenli/seq/PsychENCODE/metaeQTL/SMR/BrainMeta_cis_sqtl_summary/BrainMeta_cis_sQTL_chr    > circ_locus_input_data2.txt 


perl  /storage/yangjianLab/chenli/seq/PsychENCODE/metaeQTL/SMR/locos_plot/get_input_for_locusplot_circ_sQTL_mQTL.pl  /storage/yangjianLab/sharedata/GWAS_summary/01_Public/01_cojo/PGC3_SCZ_wave3_public_INFO80.txt  /storage/yangjianLab/guoyazhou/data/SNPs_database/dbSNP/dbSNP_b151/split_into_chrAuto/  /storage/yangjianLab/chenli/softwares/circRNA/Test_CMC/test_pipeline/merge_all/Brain.circ.all.nochr.bed    /storage/yangjianLab/guoyazhou/data/genecode_data/genecode_v43/v43lift37/gencode.v43lift37.annotation.gene.bed  "chr16:9892134|9934961"  1000000  /storage/yangjianLab/chenli/seq/PsychENCODE/metaeQTL/circRNA_meta_eQTL/BrainMeta.circRNA.chr  /storage/yangjianLab/chenli/seq/PsychENCODE/metaeQTL/SMR/BrainMeta_cis_sqtl_summary/BrainMeta_cis_sQTL_chr  /storage/yangjianLab/chenli/seq/PsychENCODE/metaeQTL/SMR/LBC_BSGS_meta/bl_mqtl_chr   > circ_locus_input_data3.txt 


GWAS_trait_name="SCZ"
GWAS_file="/storage/yangjianLab/sharedata/GWAS_summary/01_Public/01_cojo/PGC3_SCZ_wave3_public_INFO80.txt"
probe=c("chr16:9892134|9934961")
probe_gene=c("ENSG00000183454","cg15134033")
probe_gene=c("ENSG00000183454","cg01348055","cg08204867","cg16669395","cg03015368","cg08001123")
highlight_probe=c("chr16:9892134|9934961")
window_size=500000
probe_list=probe
probe_gene_list=probe_gene
filename<-"/storage/yangjianLab/chenli/seq/PsychENCODE/metaeQTL/SMR/locos_plot/circ_locus_input_data3.txt"
finemap_file<-"/storage/yangjianLab/chenli/seq/PsychENCODE/lncRNA_eQTL/enrichment/finemap/sczfinemap/scz.rs9926049.locus.CARMA.txt"
#finemap_file<-"/storage/yangjianLab/chenli/seq/PsychENCODE/lncRNA_eQTL/enrichment/finemap/sczfinemap_ANN/scz.rs9926049.locus.CARMA.ANN.txt"


##/storage/yangjianLab/chenli/seq/PsychENCODE/metaeQTL/circRNA_meta_eQTL/BrainMeta.circRNA.chr1.query.txt

plink   --bfile /storage/yangjianLab/sharedata/LD_reference/UKB/genotype_10K/BED_ukbEUR_imp_v3_INFO0.8_maf0.01_mind0.05_geno0.05_hwe1e6_10K_chr16  \
    --chr 16 \
    --from-bp 9391381  \
    --to-bp 10435389 \
    --r2 \
...
plotLegend(
    ...
    pch = c(19, 19,19,19,19,19), border = FALSE, x = x0+width0-3, y = y0-0.5,
    width = 1.5, height = 1.5, just = c("right", "top"),
    default.units = "cm"
)
  
  plotText(
    label = GWAS_trait_name, x = x0+0.2, y = y0, rot = 0,
...
#    y =  y0 , height = 21.5, just = c("left", "top"),
...
probe_gene_num=length(probe_gene_list)
  ...
  if(probe_gene_num > 0 & length(probe_gene_list)!=0 ){
    ...
    for(probe_gene in probe_gene_list){
      probe_gene_index=probe_gene_index+1
      dat1<-dat[dat$type=="sQTL",]
      gwas_locus3<-dat1[dat1$geneid==probe_gene,]
      gwas_locus3$pch <- 21
      gwas_locus3$CHR = chr
      gwas_locus3$color = "orange"
      gwas_locus3 <- gwas_locus3[,c("CHR","pos","P","SNP","color")]
      colnames(gwas_locus3) <- c("chrom","pos","p","snp","color")
...
########################## plot the gene labels #######################
  ...
  generow
  dist = 1
  yMax=y0 + (height0 + gap0)*probe_index + (height0 + gap0)*probe_gene_index + height0 + 1 + 0.8*num_row
  yMax
...
######Hi-C bedpe
    ...
    params = params,width =width0, height = height0,
    y = 19.5 ,
    fill = "purple", linecolor = "purple", flip = TRUE
		)   
		
		plotText(
        label = "NeuN.5k", x = x0, y = 19.2, 
        rot = 0,
        fontsize = 10, just = "left",
        default.units = "cm"
      )
...
##      )
			    ...
			    plotGenomeLabel(
			      chrom = chr, chromstart = start, chromend = end,
			      assembly = "hg19",
			      x = x0, y = 28.5, length = width0, scale = "Mb",
			      just = c("left", "top"), default.units = "cm",
			      fontsize = 8
			    )
...
pdf("lnc-chr16_9892134_9934961_sQTL.pdf",  width=10,height=13)  
gwasLocusPlot()
dev.off()			  
